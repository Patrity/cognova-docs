...
Deleting a task performs a soft delete. The task is hidden from the default list but can be restored. See [API Reference](/docs/api/tasks) for details on the restore endpoint.
