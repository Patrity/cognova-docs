...
- **Chat** -- A compact Claude conversation interface (see [Chat](/guide/chat) for the full-page version).
...
For more on Claude CLI integration, see [Claude Integration](/claude).

## Chat Tab

The Chat tab in the Assistant Panel is a lightweight version of the full [Chat](/guide/chat) page. It includes:
...
The Assistant Panel is great for quick questions or running a command without losing your place. For longer conversations, use the dedicated [Chat](/guide/chat) page which provides more screen real estate.
::
