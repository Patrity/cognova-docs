...
| `/secret` | Manage encrypted API keys and tokens |
...
Terminal / Web Chat
  ...
  skills/ (invoked via slash commands)
        ...
        +--- environment/environment.py --> /api/health, service status
...
- [Skills](/docs/claude/skills) -- the six built-in slash commands
- [Hooks](/docs/claude/hooks) -- the event-driven automation layer
- [Rules](/docs/claude/rules) -- contextual instructions for document handling
- [Memory System](/docs/claude/memory-system) -- how Claude remembers across sessions
- [Custom Skills](/docs/claude/custom-skills) -- build your own slash commands
- [Community Library](/docs/claude/community-library) -- install skills from the public registry
