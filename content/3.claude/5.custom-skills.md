...
Authentication uses the `.api-token` file generated during Cognova setup. The client checks multiple paths (project directory, install directory, working directory) so it works across all deployment types.
