...
- [Docker Compose](/self-hosting/docker) -- containerized deployment
- [Coolify](/self-hosting/coolify) -- one-click deploy with a self-hosted PaaS
- [Production Checklist](/self-hosting/production) -- hardening for remote access
