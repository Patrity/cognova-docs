...
The hooks API records and analyzes events from Claude Code hooks. Hooks fire at key lifecycle points (session start/end, before/after tool use) and can block dangerous operations. See [Claude Hooks](/docs/claude/hooks) for configuration.
