...
All TypeScript interfaces for request/response shapes are defined in `shared/types/`. See the [Database Schema](/docs/architecture/database) page for the full type definitions -- they are not duplicated in this reference.
