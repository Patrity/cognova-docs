...
cognova/
  ...
  docker-compose.yml    # Docker Compose for local dev database
...
cli/
  src/
    ...
    templates/          # String generators for .env, CLAUDE.md, launchd plist, systemd unit
...
See [Claude Integration](/docs/claude) for details on each component.
