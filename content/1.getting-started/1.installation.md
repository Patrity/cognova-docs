...
Cognova gives Claude Code unrestricted shell access. If exposed to a network, always put a reverse proxy with TLS in front. See the [production checklist](/getting-started/production).
::
...
See [CLI Commands](/getting-started/cli-commands) for details on each command.
