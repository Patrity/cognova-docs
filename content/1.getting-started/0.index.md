...
- [Installation](/getting-started/installation) -- detailed prerequisites and setup
- [Configuration](/getting-started/configuration) -- environment variable reference
- [CLI Commands](/getting-started/cli-commands) -- managing your installation
- [Production Checklist](/getting-started/production) -- hardening for remote access
- [Guide](/guide) -- feature walkthroughs for the web UI
- [Claude Integration](/claude) -- skills, hooks, rules, and memory
